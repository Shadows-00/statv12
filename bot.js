...
let kayıt = "794205024598884372"
let terapi = "KATAGORİ İD"
let sorun = "794562048394264627"
let vk = "794208106417618984"
let dc = "794208182066085888"
let game = "794208266082713620"
let priv = "794208303848488971"
...
client.on ( "message" , async message => {
    ...
    if(!['793874557475356674'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) return message.react('❌')
    var totall = (
                     await db.fetch (
